...
namespace PixelRender
{
	public class PaletteEditor : EditorWindow 
	{
		...
		private const string PrefsKeyMode = "Pixelated.PixelRender.PaletteEditor.Mode";
		private const string PrefsKeyHue = "Pixelated.PixelRender.PaletteEditor.Hue";
		private const string PrefsKeySaturation = "Pixelated.PixelRender.PaletteEditor.Saturation";
		private const string PrefsKeyLuminance = "Pixelated.PixelRender.PaletteEditor.Luminance";
		...
		[MenuItem( "Window/Pixelated/PixelRender/Palette Editor")]
		...
		private void ShadeCountChanged( GUIBase sender)
		{
			...
			if( IsTextureReadWrite( palette))
			{
				...
				string path = AssetDatabase.GetAssetPath( Shader.Find( "Pixelated/PixelRender/PixelArtShader"));
