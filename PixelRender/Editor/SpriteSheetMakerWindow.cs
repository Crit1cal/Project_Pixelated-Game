...
namespace PixelRender
{
	...
	{
		private const string _RootName = "com.Pixelated.PixelRender.SpriteSheetMaker.RootGameObject";
		private const string _ModelName = "com.Pixelated.PixelRender.SpriteSheetMaker.ModelGameObject";
		private const string _CameraName = "com.Pixelated.PixelRender.SpriteSheetMaker.PreviewCamera";
		...
		[MenuItem( "Window/Pixelated/PixelRender/Sprite Sheet Maker")]
		...
		private Material[] GetUniquePixelArtMaterials( GameObject gameObject)
		{
			...
			foreach( Renderer renderer in renderers)
			{
				if( renderer.sharedMaterial.shader.name == "Pixelated/PixelRender/PixelArtShader")
				{
